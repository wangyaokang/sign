...
public class DescEncript {
	...
	public static void main(String[] args) throws Exception {
		// DBJNqOjgZGet+SdI2Nkp/A==
		String username = "880029504808";
		String key = "6Ta4OaHZdpA=";
		DescEncript encript = new DescEncript();
		encript.setKEY(key);
		System.out.println(encript.encode(username));
	}
}
